...
export const productoSchema = z.object({
  ...
  subcategory_id: z.string().uuid("subcategoria requerida"),
  stock: z
    .number()
    .int()
    .positive("El stock debe ser un número entero positivo"),
  price: z.number().min(0, "El precio debe ser mayor o igual a 0"),
  state: z.enum(["available", "not available"]).default("available"),
  images: z
    .array(z.string())
...
export const updateProductoSchema = z.object({
  ...
  subcategory_id: z
    .string()
    .uuid("La subcategoría debe ser un UUID")
    .optional(),
...
export const productBySubCategorySchema = z.object({
  id_subcategory: z.string().uuid("El ID de la subcategoría debe ser un UUID"),
});
